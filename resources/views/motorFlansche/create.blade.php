...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 text-muted">
                        {{Form::text('name','', ['class' => 'form-control','readonly' => 'true','placeholder' =>'Bsp.: 6 x M8/13 x 101.6/47mm'])}}
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8 text-muted">
                        {{Form::text('name_zusatz','', ['class' => 'form-control', 'placeholder' =>'Bsp.: Standard'])}}
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="col-3">
                                M10 {{Form::radio('schraubengroesse','M10', false, [])}}
                        </div>
                        <div class="col-3">
                                1/2" {{Form::radio('schraubengroesse','1/2Zoll', false, [])}}
                        </div>
                        <div class="col-3">
                            7/16" {{Form::radio('schraubengroesse','7/16Zoll', false, [])}}
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        {{Form::number('mitnehmerzapfen_durchmesser','', ['class' => 'form-control','step' => '0.1','min' => '0', 'max' => '16', 'placeholder' =>'Bsp.: 13'])}}
                    </div>
                </div>
                <div class="form-group row">
                    {{Form::label('teilkreis_durchmesser','TK [mm]',['class' => 'col-sm-3 col-form-label'])}}
                    <div class="col-sm-8">
                        {{Form::number('teilkreis_durchmesser','', ['class' => 'form-control','step' => '0.1','min' => '30', 'max' => '200', 'placeholder' =>'Bsp.: 101.6'])}}
                    </div>
                </div>
                <div class="form-group row">
                    {{Form::label('zentrier_durchmesser','Zentrierung [mm]',['class' => 'col-sm-3 col-form-label'])}}
                    <div class="col-sm-8">
                        {{Form::number('zentrier_durchmesser','', ['class' => 'form-control','step' => '0.1','min' => '0', 'max' => '55', 'placeholder' =>'Bsp.: 47'])}}
                    </div>
                </div>
                <div class="form-group row">
                    {{Form::label('zentrier_hoehe','Höhe Zentrierung [mm]',['class' => 'col-sm-3 col-form-label'])}}
                    <div class="col-sm-8">
                        {{Form::number('zentrier_hoehe','', ['class' => 'form-control','step' => '0.1','min' => '0', 'max' => '10', 'placeholder' =>'Bsp.: 5'])}}
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        {{Form::textarea('bemerkung_flansch','', ['class' => 'form-control','rows' => 3, 'placeholder' =>'500 Zeichen für Infos'])}}
                    </div>
                </div>
    ...
    <div class="col-xl-4">
        <button id = "flanschliste" type="button" class="btn btn-info"><span class="oi" data-glyph="eye"></span> Bisher angelegte Motorflansche</button>
        <div class="flanschliste">
            @foreach($motorflansche as $key => $motorflansch)
                {{ $motorflansch }}<br>
            @endforeach    
        </div>
    </div>    
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#flanschliste").ready(function(){
            $(".flanschliste").toggle();
        });
        $("#flanschliste").click(function(){
            $(".flanschliste").toggle();
        });
