...
<h1>Motorflansch {{ $motorFlansch->name }} für Motor {{ $motorFlansch->motor->name }} bearbeiten</h1>
<div class="row">
    <div class="col-xl-4">
        <div class="card mb-4">
            <div class="card-body">
                {!! Form::open(['action' => ['MotorFlanscheController@update', $motorFlansch->id], 'method' => 'POST']) !!}
                    <div class="form-group row">
                        {{Form::label('name','Name',['class' => 'col-sm-3 col-form-label'])}}
                        <div class="col-sm-8 text-muted">
                            {{Form::text('name',$motorFlansch->name, ['class' => 'form-control','readonly' => 'true'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            {{Form::hidden('motor_id',$motorFlansch->motor->id)}}
                            {{Form::text('motorname',$motorFlansch->motor->name, ['class' => 'form-control','readonly' => 'true'])}}
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="col-3">
                                @if($motorFlansch->schraubengroesse == 'M10')
                                    M10 {{Form::radio('schraubengroesse','M10', true, ['checked' => 'checked'])}}
                                @else
                                    M10 {{Form::radio('schraubengroesse','M10', false, [])}}
                                @endif
                            </div>
                            <div class="col-3">
                                @if($motorFlansch->schraubengroesse == '1/2Zoll')
                                    1/2" {{Form::radio('schraubengroesse','1/2Zoll', true, ['checked' => 'checked'])}}
                                @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            {{Form::textarea('bemerkung_flansch',$motorFlansch->bemerkung_flansch, ['class' => 'form-control','rows' => 3, 'cols' => 10, 'placeholder' =>'500 Zeichen für Infos'])}}
                        </div>
                    </div>
