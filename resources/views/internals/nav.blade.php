            ...
            <div class="dropdown">
                ...
                @if(Auth::user()->id != 13 && Auth::user()->id != 14 && Auth::user()->id != 15 && Auth::user()->id != 16)
                    <ul class="dropdown-menu">
                        ...
                        <a id="dropdown" href="{{ route('cart.index') }}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Artikelkorb <span class="oi" data-glyph="cart" title="bearbeiten" aria-hidden="true"></span> {{ \Cart::getTotalQuantity()}}
                        </a>
