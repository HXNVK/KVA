...
@section('content')
    <h1>Blockdaten für Blatt "{{ $psc_blattBlock->name }}" ändern</h1>
    ...
    <div class="form-group">
        {!! Form::open(['action' => ['PropellerStepCodeBlattBloeckeController@update', $psc_blattBlock->id], 'method' => 'POST']) !!}
            <div>
                <div class="row">
                    {{Form::label('propeller_modell_blatt','Propeller Blattmodell',['class' => 'col-2 col-form-label'])}}
                    <div class="col-4">
                        {{Form::text('name',$psc_blattBlock->name, ['class' => 'form-control', 'readonly' => 'true'])}}
                    </div>
                </div>
                <div>
                    <div class="col-12">
