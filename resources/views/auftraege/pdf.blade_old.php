    ...
    <body>
        ...
        @if($auftrag->auftragTyp->id == 1)
                ...
                <div>
                    {{-- <table cellpadding="0" cellspacing="0">
                        <tr>
                            <th style="width: 750px">Form</th>
                            <th style="width: 150px">Bauweise</th>
                        </tr>
                        <tr>
                            <td style="width: 750px; font-size: 20pt; font-weight: 900;">{{ $auftrag->propellerForm }}</td>
                            <td style="width: 150px; font-size: 20pt; font-weight: 900;">{{ $auftrag->ausfuehrung }}</td>
                        </tr>
                    </table> --}}
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                ...
                <div>
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="width: 800px; height: 50px; text-align:left">{{ $auftrag->notiz }}</td>
                            <td style="width: 100px; font-size: 20pt">{{ $auftrag->form1 }}</td>
                        </tr>
                    </table>
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td style="width: 125px; font-size: 20pt">
                            ...
                            <td style="width: 125px; font-size: 15pt">
                            ...
                            <td style="font-size: 20pt; width: 350px; font-weight: 900">{{ $auftrag->motorFlansch }}</td>
                            <td style="font-size: 10pt; width: 300px">
            ...
            @if(Str::of($auftrag->propeller)->containsAll(["H50"]) ||
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            <td style="width: 150px; height: 50px">{{ $auftrag->kantenschutzband }}</td>
                            <td style="font-size: 12pt; width: 150px; height: 50px; text-align:left">W [gr] <</td>
                            <td style="width: 160px; height: 50px"></td>
                            <td style="width: 230px; height: 50px"></td>
                            <td style="width: 210px; height: 50px"></td>
                        </tr>
                        <tr>
                            <td style="font-size: 12pt; width: 160px; height: 50px; text-align:left">Stg. [°] =</td>
                            <td style="font-size: 12pt; width: 160px; height: 50px; text-align:left">Spl. [mm] <</td>
                    ...
                    <div>
                        <table cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td style="width: 180px; text-align:center"></td>
                                <td style="width: 180px; text-align:center"></td>
                                <td style="width: 700px; text-align:center; font-size: 20pt">{{ $auftrag->teilauftrag }}</td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                ...
                <div>
                    <table>
                        ...
                        <tr>
                            <td style="font-size: 12pt; width: 160px; height: 50px; text-align:left">Stg. [°] =</td>
                            <td style="font-size: 12pt; width: 160px; height: 50px; text-align:left">Spl. [mm] <</td>
                            <td style="width: 300px; height: 25px">Anzahl / Datum / endgefertigt von</td>
                            <td style="width: 300px; height: 25px">Anzahl / Datum / geprüft von</td>
                        </tr>
                    </table>
                </div>
            @endif
