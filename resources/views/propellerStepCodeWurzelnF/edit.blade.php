...
@section('content')
    <h1>Wurzeldaten F für StepCode ändern</h1>
    ...
    <div class="form-group">
        {!! Form::open(['action' => ['PropellerStepCodeWurzelnFController@update', $psc_WurzelF->id], 'method' => 'POST']) !!}
            <h1>Input Wurzel F, K, S</h1>
            <div>
                <div class="row">
                    {{Form::label('propeller_modell_wurzel','Wurzelmodell',['class' => 'col-2 col-form-label'])}}
                    <div class="col-2">
                        {{Form::text('name',$psc_WurzelF->name, ['class' => 'form-control', 'readonly' => 'true'])}}
                    </div>
                </div>
                <div class="row">
