...
@section('content')
<a href="/kunden/{{$kundeFinanzdatei->kunde_id}}" class="btn btn-success">
    <span class="oi" data-glyph="arrow-thick-left" title="home" aria-hidden="true"></span>
</a>
<h1>Finanzdaten bearbeiten von {{ $kundeFinanzdatei->kunde->matchcode }}</h1>
<div class="row">
    <div class="col">
    {!! Form::open(['action' => ['KundeFinanzdatenController@update',$kundeFinanzdatei->id], 'method' => 'POST']) !!}
        <div class="form-group row">
            {{Form::label('id','Kunden ID',['class' => 'col-sm-1 col-form-label'])}}
            <div class="col-sm-2">
                {{Form::text('id', $kundeFinanzdatei->kunde_id, ['class' => 'form-control','readonly' => 'true'])}}
            </div>
        </div> 
        <div class="form-group row"> 
            ...
            <div class="col-sm-2">
                <select class="form-control" name="kunde_finanzdatei_zahlungsart_id">
                    <option value="{{ $kundeFinanzdatei->kundeFinanzdateiZahlungsart->id }}">{{ $kundeFinanzdatei->kundeFinanzdateiZahlungsart->name }}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <select class="form-control" name="kunde_finanzdatei_zahlungsziel_id">
                    <option value="{{ $kundeFinanzdatei->kundeFinanzdateiZahlungsziel->id }}">{{ $kundeFinanzdatei->kundeFinanzdateiZahlungsziel->name }}</option>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                {{Form::text('steuernummer',$kundeFinanzdatei->steuernummer, ['class' => 'form-control','placeholder' =>'Bsp.: DE 999999999 (9 Ziffern)'])}}
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                {{Form::textarea('notiz',$kundeFinanzdatei->notiz, ['class' => 'form-control','placeholder' =>'100 Zeichen für Infos'])}}
            </div>
        </div>
